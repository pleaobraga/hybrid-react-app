...
app.get('*', function (req, res) {
    ...
    var promisses = (0, _reactRouterConfig.matchRoutes)(_Routes2.default, req.path).map(function (_ref) {
...
var Home = function Home() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'p',
            null,
            'Check out these awsome features'
        )
    );
};
...
var maptateToProps = function maptateToProps(_ref) {
...
exports.default = {
    loadData: loadData,
    component: (0, _reactRedux.connect)(maptateToProps, { fetchUsers: _actions.fetchUsers })(UsersList)
};
